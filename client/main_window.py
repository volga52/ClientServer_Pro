...
class ClientMainWindow(QMainWindow):
    ...
    def history_list_update(self):
        ...
        # и разным фоном. Записи в обратном порядке, поэтому выбираем их с
        # конца и не более 20
    ...
    # Функция обработчик дабл_клика по контакту
    ...
    def set_active_user(self):
        '''Метод активирует чат с собеседником.'''
    ...
    def clients_list_update(self):
        '''Метод обновляет список контактов.'''
    ...
    def add_contact_window(self):
        '''Метод создает окно - диалог добавления контакта'''
    ...
    def add_contact(self, new_contact):
        '''
        Метод добавляет контакт в серверную и клиентсткую BD.
        ...
        try:
            ...
            self.messages.information(
                self, 'Удачно', 'Контакт успешно добавлен.')

    # Функция удаления контакта
    def delete_contact_window(self):
        '''Метод создает окно удаления контакта.'''
    ...
    def delete_contact(self, item):
        '''
        Метод удаляет контакт из серверной и клиентсткой BD.
        После обновления баз данных обновляет и содержимое окна.
        '''
        ...
        try:
            ...
            self.messages.information(
                self, 'Удачно', 'Контакт успешно удалён.')
            item.close()
    ...
    def send_message(self):
        '''
        Функция отправляет сообщения текущему собеседнику.
    ...
    # Функция декодирует сообщение
    def decryption(self, message):
        '''Функция выполняет расшифровку сообщений'''
    ...
    def message(self, message):
        '''
        Слот обработчик поступаемых сообщений, их сохранение в истории сообщений.
        Запрашивает пользователя если пришло сообщение не от текущего
        собеседника. При необходимости меняет собеседника.
        '''
        decrypted_message = self.decryption(message)
        # Получаем строку байтов
        encrypted_message = base64.b64decode(message[MESSAGE_TEXT])
        # Декодируем строку, при ошибке выдаём сообщение и завершаем функцию
        try:
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                # Если есть, спрашиваем 'открыть с ним чат?' и открываем при
                # желании
