...
class ClientMainWindow(QMainWindow):
    ...
    def history_list_update(self):
        ...
        _list = sorted(self.database.get_history(self.current_chat), key=lambda item: item[3])
    ...
    def add_contact(self, new_contact):
        ...
        try:
            ...
            self.messages.information(self, 'Удачно', 'Контакт успешно добавлен.')
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.messages.information(self, 'Удачно', 'Контакт успешно удалён.')
            item.close()
    ...
    def message(self, message):
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                # Если есть, спрашиваем 'открыть с ним чат?' и открываем при желании
    ...
    # Функция принимает синалы из clien.py
