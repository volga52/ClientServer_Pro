...
Серверный модуль мессенджера. Передает сообщения от одного клинта сети другому.
...
Запускаемый модуль, функционал инициализации приложения заложен в основную функцию main.
